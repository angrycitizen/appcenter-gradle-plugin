package ru.mosgorpass.gradle.appcenter.extensions
...
open class AppCenterExtension(val project: Project) {
    ...
    var apps: NamedDomainObjectContainer<AppCenterAppExtension> =
        project.container(AppCenterAppExtension::class.java) {
    ...
    var distributionGroups: List<String>
        get() = _distributionGroups ?: getGlobalConfig(
            "APPCENTER_DISTRIBUTION_GROUPS",
            ""
        ).split(",")
        set(value) {
