...
class AppCenterUploader(
    ...
    fun uploadApk(
        ...
        apiClient.commitReleaseUpload(ownerName, appName, preparedUpload.id, commitRequest)
            .executeOrThrow()
        ...
        do {
            ...
            uploadResult =
                apiClient.getUpload(ownerName, appName, preparedUpload.id).executeOrThrow()
    ...
    fun uploadSymbols(
        ...
        val preparedUpload =
            apiClient.prepareSymbolUpload(ownerName, appName, prepareRequest).executeOrThrow()
        ...
        apiClient.commitSymbolUpload(
            ownerName,
            appName,
            preparedUpload.symbolUploadId,
            commitRequest
        ).executeOrThrow()
    }
}
